...
int main()
{
    ...
    vector<string> class_names = {"sign_red", "sign_green", "sign_yellow"};


    auto model = readNetFromTensorflow("tensor/peso.pb","tensor/algo.txt");
    ...
    Mat blob = blobFromImage(image, 0.00392, Size(300, 300), Scalar(127.5, 127.5, 127.5), true, false);
